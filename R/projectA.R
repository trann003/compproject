...
wordcloud(wordNames_covid, wordCounts_covid, max.words = 50, scale=c(4,.2))

# wordcloud - COVID19
wordCounts_covid19 <- colSums(twitter_covid19_tbl)
wordNames_covid19 <- names(twitter_covid19_tbl)
wordcloud(wordNames_covid19, wordCounts_covid19, max.words = 50, scale=c(4,.2))

# wordcloud - COVID-19
wordCounts_covid_19 <- colSums(twitter_covid_19_tbl)
wordNames_covid_19 <- names(twitter_covid_19_tbl)
wordcloud(wordNames_covid_19, wordCounts_covid_19, max.words = 50, scale=c(4,.2))

# wordcloud - COVID_19
wordCounts_covid_19_ <- colSums(twitter_covid_19__tbl)
wordNames_covid_19_ <- names(twitter_covid_19__tbl)
wordcloud(wordNames_covid_19_, wordCounts_covid_19_, max.words = 50, scale=c(4,.2))
...
# App
"https://trann003.shinyapps.io/projectA/"
